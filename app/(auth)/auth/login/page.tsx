    ...
    <div className="w-full max-w-md rounded-2xl border border-black/10 p-6 sm:p-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full h-11 rounded-xl bg-brand-green text-white shadow-sm ring-1 ring-black/5 text-sm font-semibold hover:bg-brand-greenLight transition-colors disabled:opacity-60 flex items-center justify-center gap-2"
        >
        ...
        <button
          ...
          disabled={loading}
          className="w-full h-11 rounded-xl bg-white border border-black/10 text-black shadow-sm text-sm font-semibold hover:bg-slate-50 transition-colors disabled:opacity-60 flex items-center justify-center gap-2"
        >
